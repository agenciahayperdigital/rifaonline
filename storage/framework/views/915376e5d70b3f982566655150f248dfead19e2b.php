            	...
            	<div class="card-body">
            		<form action="<?php echo e(route('update_gateway_pagamento')); ?>" method="POST">
                    	...
                    	<div class="mb-3">
                    		...
                    		<input type="text" name="paggue_client_key" id="paggue_client_key" value="<?php echo e($users->paggue_client_key); ?>" class="form-control form-control-sm" aria-describedby="emailHelp">
                    	...
                    	<div class="mb-3">
                    		...
                    		<input type="text" value="<?php echo e($users->paggue_client_secret); ?>" name="paggue_client_secret" id="paggue_client_secret" class="form-control form-control-sm" aria-describedby="emailHelp">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/script42/teste.sistemadirifa.com/resources/views/gateway-pagamento.blade.php ENDPATH**/ ?>