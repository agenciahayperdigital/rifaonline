        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-12 rifas mb-4">
                <div class="text-center">
                    ...
                    <p>Para fazer uma busca mais eficaz, aperte no seu teclado <b>[ CTRL + F ]</b> para pesquisar o ganhador!<br> Obs: Essa função está disponivel para acesso pelo notebook ou computador!</p>
                </div>
                <hr>
                    ...
                    <?php $__currentLoopData = $rifa->participantes(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $participante): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="row body-resumo pt-2">
                            <div class="col-md-3 d-flex align-items-center">
                                ...
                                <a href="<?php echo e($participante->linkWpp()); ?>&text=Olá *<?php echo e($participante->name); ?>.* Agradecemos a sua participação na ação: *<?php echo e($participante->rifa()->name); ?>*. Suas cotas são: *<?php echo e($participante->numbersResumo()); ?>*" target="_blank"><b><span class="badge bg-success"><i class="fab fa-whatsapp"></i> Enviar Bilhete Whatsapp</span></b></a>
                            </div>
                            <div class="col-md-3 d-flex align-items-center">
                            ...
                            <div class="col-md-3 d-flex align-items-center">
                                <label><span class="badge text-bg-success"><?php echo e($participante->reservados > 0 ? 'Reservado' : 'PAGT CONFIRMADO'); ?></span></label>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/explo595/sistemadirifa.online/resources/views/resumoRifa.blade.php ENDPATH**/ ?>