    ...
    <div class="row">
        <div class="col-md-12 text-center">
            ...
            <a class="btn btn-primary" style="background-color: #25d366;border: none;"
                href="https://api.whatsapp.com/send?text=<?php echo e(Request::url()); ?>" target="_blank"
...
<input type="number" style="text-align: center;background-color: #E5E5E5;color: #000000;font-weight: bold; display:none" id="numbersA" value="<?php echo e($productModel->minimo); ?>" min="<?php echo e($productModel->minimo); ?>" max="<?php echo e($productModel->maximo); ?>" onblur="numerosAleatorio();" onkeyup="numerosAleatorio()" class="form-control" placeholder="Quantidade de cotas">
...
<!-- Footer -->
<?php /**PATH /home1/explo595/sistemadirifa.online/resources/views/rifas/manual.blade.php ENDPATH**/ ?>