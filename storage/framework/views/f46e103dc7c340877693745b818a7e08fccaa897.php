    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="display-6" id="exampleModalLabel">Detalhes Compra</h6>
...
<?php /**PATH /home2/script42/teste.sistemadirifa.com/resources/views/compras/modal/detalhes.blade.php ENDPATH**/ ?>