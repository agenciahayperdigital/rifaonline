			...
			<div class="card app-card mb-2 pointer border-bottom-warning">
				<div class="card-body">
					<div class="row  row-gutter-sm">
						...
						<div class="col ps-2">
						    <div class="compra-title font-weight-500"><?php echo e($reserva->rifa()->name); ?></div>
							<small class="compra-data font-xss opacity-50">Reservado ás: <?php echo e(date('d/m/Y H:i', strtotime($reserva->created_at))); ?></small><br><hr>
							<small class="font-xss opacity-75 text-uppercase"><?php echo e($reserva->status()); ?> (<?php echo e($reserva->pagos + $reserva->reservados); ?> COTAS)</small>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/script42/teste.sistemadirifa.com/resources/views/minhas-reservas.blade.php ENDPATH**/ ?>