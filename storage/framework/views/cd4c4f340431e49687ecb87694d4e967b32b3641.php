    ...
    <div class="card" style="border: none;border-radius: 10px;background-color: transparent;">
        <div class="card-body" style="background-color: #f1f1f1;border: none;border-radius: 10px;">
            ...
            <div class="row text-center">
                <h1 class="display-6">Ranking do Sorteio <br><?php echo e($rifa->name); ?></h1>
            </div>
...
<?php endif; ?>
<?php /**PATH /home2/script42/teste.sistemadirifa.com/resources/views/ranking-admin.blade.php ENDPATH**/ ?>