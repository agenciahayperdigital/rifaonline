        ...
        <div class="col-md-4 rifas">
            ...
            <div class="content-fluid">
                <div class="app-title <?php echo e($config->tema); ?> text-center">
                    <h1><i class="fas fa-gamepad"></i> Medieval</h1>
                </div>
            </div>
            ...
            <div class="content-fluid">
                <div class="col-12">
                	<div class="row">
                	    <iframe id="myIframe" src="https://pt.playbonds.com/Game/Load/3596/?Demo=yes&amp;REFERER=pt.playbonds.com&amp;IdSite=1&amp;Channel=Casino&amp;sl=pt" allowfullscreen="" width="100%" height="400"></iframe>
                	</div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/explo595/sistemadirifa.online/resources/views/games/gameMedieval.blade.php ENDPATH**/ ?>