                            ...
                            <tbody>
                                <?php $__currentLoopData = $afiliados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $afiliado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <th scope="row"><?php echo e($afiliado->id); ?></th>
                                        <td><?php echo e($afiliado->name); ?></td>
                                        <td><?php echo e($afiliado->email); ?></td>
                                        <td><?php echo e($afiliado->telephone); ?></td>
                                        <td>
                                            <a href="#">
                                                <span
                                                    class="badge <?php echo e($afiliado->status === 1 ? 'bg-success' : 'bg-danger'); ?>">
                                                    <?php echo e($afiliado->status === 1 ? 'Ativo' : 'Inativo'); ?>
                                        ...
                                        <td>
                                            <div>
                                                ...
                                                <a href="<?php echo e(route('painel.excluirAfiliado', ['id' => $afiliado->id])); ?>"
                                                    type="button" class="btn btn-sm btn-danger">Excluir</a>
                                                <a href="<?php echo e(route('detalhesAfiliados', ['id' => $afiliado->id])); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/script42/teste.sistemadirifa.com/resources/views/listaAfiliados.blade.php ENDPATH**/ ?>