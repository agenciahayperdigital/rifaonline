...
<head>
    ...
    <?php if(!is_null(@$data['ads']->PiexelPageViwer) && @$data['ads']->PiexelPageViwer !== ''): ?>
...
<body>
            ...
            <div class="col-md-6 col-12  d-flex justify-content-between align-items-center">
                <div>
                    <a class="" href="<?php echo e(route('inicio')); ?>"
                        ...
                        <?php if(@$data['social']->logo): ?>
                            <img src="<?php echo e(asset('products/' . @$data['social']->logo)); ?>" alt="www.sistemadirifa.com"
                                width="160" height="60">
                        <?php else: ?>
                ...
                <div>
                    <?php if(@$data['social']->instagram != null): ?>
                        <a href="<?php echo e(@$data['social']->instagram); ?>"
                    ...
                    <?php if(@$data['social']->group_whats != null): ?>
                        <a href="<?php echo e(@$data['social']->group_whats); ?>"
                            style="text-decoration: none; font-size: 20px; color: #fff" target="_blank">
                            <span class="badge  p-2" style="font-size: 10px;">
                    ...
                    <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#consultar-reservas"
                        onclick="openModal()" style="text-decoration: none; font-size: 20px; color: #fff"
                        target="_blank">
                        <span class="badge  p-2" style="font-size: 10px;">
    ...
    <menu id="mobileMenu" class="modal fade modal-fluid" tabindex="-1" aria-labelledby="mobileMenuLabel"
        ...
        <ul>
         ...
         <li>
         <a class="text-white" alt="Página Principal" href="<?php echo e(route('novoCadastro')); ?>">
         ...
         <li>
         <a class="text-white" alt="Página Principal" href="<?php echo e(route('entreEmContato')); ?>">
         <i class="fa-solid fa-envelope-circle-check"></i>
         <span>Entre em Contato</span>
         </a>
         </li>
         <li>
         <a class="text-white" alt="Página Principal" href="<?php echo e(route('todosOsGanhadores')); ?>">
         <i class="fas fa-gamepad"></i>
         <span>Jogos Gratuitos</span>
         </a>
         </li>
         <li>
         <a class="text-white" alt="Página Principal" href="<?php echo e(route('termosDeUsoEParticipacao')); ?>">
         ...
         <span>Termos de Uso & Participação</span>
                        ...
                        <div class="text-center pb-1"><a type="button" href="/"
                                ...
                                Inicial</a></div>
                        <div class="text-center pb-1"><a type="button" href="<?php echo e(route('novoCadastro')); ?>"
                        ...
                        <div class="text-center pb-1"><a type="button" href="/area-afiliado" target="_blank"
                                ...
                                de Afiliados</a></div>
                        <div class="text-center pb-1"><a type="button" href="<?php echo e(route('entreEmContato')); ?>"
                                class="btn btn-dark w-100 rounded-pill"><i class="icone bi bi-envelope"></i> Entre em
                                Contato</a></div>
                        
                        <div class="text-center pb-1"><a type="button"
                                href="<?php echo e(route('termosDeUsoEParticipacao')); ?>"
...
<?php /**PATH /home1/explo595/sistemadirifa.online/resources/views/layouts/app.blade.php ENDPATH**/ ?>