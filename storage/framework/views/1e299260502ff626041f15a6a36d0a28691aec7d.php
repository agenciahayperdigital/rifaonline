                    ...
                    <div class="row">
                        <div class="col-12 col-sm-12 text-center">
                            <?php if(env('APP_NAME') == 'Laravel'): ?>
                                <p class="mb-0 text-muted text-medium">Desenvolvido por <a target="_blank" href="https://sistemadirifa.com">Sistema de Rifas</a> | &copy; Copyright. Todos os direitos reservados.</p>
                            <?php else: ?>
...
<?php /**PATH /home2/script42/teste.sistemadirifa.com/resources/views/afiliados/layout/menuAfiliados.blade.php ENDPATH**/ ?>