...
<head>
    ...
    <link href="<?php echo e(asset('/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css')); ?>" rel="stylesheet">
                ...
                <li class="nav-item">
                    <a class="nav-link">
                        <form name="logout" action="<?php echo e(route('logout')); ?>" method="POST">
                            ...
                            <span class="badge badge-danger" onclick="javascript:logout.submit()"><i class="fas fa-sign-out-alt"></i> SAIR</span>
                        </form>
                    </a>
                </li>
            </ul>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('gateway_pagamento')); ?>" class="nav-link <?php echo e(request()->is('gateway_pagamento*') ? 'active' : ''); ?>" id="perfil">
                                <i class="fas fa-hand-holding-usd"></i>
                                <p>Gateway de Pagamento</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('pixel_google_ads')); ?>" class="nav-link <?php echo e(request()->is('pixel_google_ads*') ? 'active' : ''); ?>" id="perfil">
                                <i class="fas fa-code"></i>
                                <p>Pixel & Google ADS</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('listClientes')); ?>" class="nav-link <?php echo e(request()->is('clientes*') ? 'active' : ''); ?>" id="clientes">
                        ...
                        <li class="nav-item">
                            <a href="https://sorteador.com.br/" target="_blank" class="nav-link" >
...
<?php /**PATH /home1/explo595/sistemadirifa.online/resources/views/layouts/admin.blade.php ENDPATH**/ ?>