    ...
    <div class="row">
    	<div class="col-sm-12">
            <div class="alert alert-success text-center" role="alert">
                ...
                <p>Para incluir um sorteio, é necessário preencher todos os campos abaixo. Importante destacar que antes de cadastrar qualquer sorteio, é imperativo configurar as credenciais de pagamento do Mercado Pago no seu sistema. Basta acessar: <b>(Menu > Gateway de Pagamentos)</b> e realizar a configuração.</p>
                <hr>
                <p class="mb-0">Caso deseje cancelar a criação do sorteio <a href="meus-sorteios" class="badge badge-danger">CANCELAR CRIAÇÃO</a></p>
            </div>
        </div>
    </div>
    		    ...
    		    <div class="row col-sm-12">
                            ...
                            <div class="card-body ">
                                <div class="form-group">
                                    <select name="modo_de_jogo" class="form-control" required>
                                        ...
                                        <option value="numeros">1 até 2.000.000 Cotas (Reserva Automática)</option>
                                        <option value="fazendinha-completa">Fazendinha - Grupo Completo (Reserva Manual)</option>
                                        <option value="fazendinha-meio">Fazendinha - Meio Grupo (Reserva Manual)</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body ">
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="price" placeholder="Ex: 0,35" maxlength="5" id="price" required />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body ">
                                <div class="form-group">
                                    <input type="number" class="form-control" name="minimo"
                                        min="1" max="5001" value="1" required />
                            ...
                            <div class="card-body ">
                                <div class="form-group">
                                    <input type="number" class="form-control" name="maximo"
                                        min="1" max="5001" value="5000" required />
                	...
                	<div class="col-sm-6">
                        <div class="card card-outline">
                            ...
                            <div class="card-body ">
                                <div class="form-group">
                                    <input type="number" class="form-control" name="numbers" min="1" max="2000001" placeholder="Ex: 150000" required />
                                    <div id="emailHelp" class="form-text">Escolha entre 1 e 2.000.000, digite somente os números.</div>
                                </div>
                            </div>
                        </div>
                	</div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/explo595/sistemadirifa.online/resources/views/adiciona-novo-sorteio.blade.php ENDPATH**/ ?>