            ...
            <div class="container mt-3" style="max-width:100%;min-height:100%;">
                <div class="table-wrapper ">
                    <div class="table-title">
                        ...
                        <div class="row">
                            <p>Obs.: As ações disponíveis são somente de confirmação de pagamento, após fazer a transferência por PIX para o colaborador basta confirmar no painel o pagamento!</p>
                        </div>
                                                <!-- Footer -->
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/script42/teste.sistemadirifa.com/resources/views/solicitacaoAfiliados.blade.php ENDPATH**/ ?>