        ...
        <div class="card text-center">
			...
			<div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
				<form class="form-signin" method="POST" action="{{ route('login') }}">
					...
					<div class="form-outline mb-3 form-group{{ $errors->has('email') ? ' has-error' : '' }}">
					    <label class="form-label" for="email"><strong>Email Administrativo</strong></label>
						<input id="email" type="email" class="form-control form-control-lg" name="email" value="{{ old('email') }}" required placeholder="teste@sistemadirifa.com" />
					</div>
					<!-- Password input -->
