...
@if (!is_null(@$data['ads']->PiexelAddToCart) && @$data['ads']->PiexelAddToCart !== '')
                ...
                <section class="title-payment-container">
                    <section class="title-payment-content">
                        ...
                        <section class="title-payment-texts mt-3 ml-3">
                            <h2 class="title-payment-text {{ $config->tema }}" id="payment-text" x-text="paymentText">
                        ...
                        if (data.status === true) {
                            ...
                            setTimeout(function() {
                                window.location.href =
                                    "{{ route('pagamentoSucesso', [$rifa, $participante]) }}";
                            }, 2000);
