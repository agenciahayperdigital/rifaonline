    ...
    <div class="row">
        <div class="col-sm-6">
    	    <div class="card card-danger card-outline">
                ...
                <div class="card-body">
                    <form action="{{ route('update_pixel_google_ads') }}" method="POST">
                    {{ csrf_field() }}
                    	...
                    	<div class="mb-3">
                    		...
                    		<input value="{{ $ads->cod_verif_dom_facebook }}" type="text" 
                    	...
                    	<div class="mb-3">
                            ...
                            name="PiexelPageViwer"
                             rows="5">{{$ads->PiexelPageViwer}}</textarea>
                    	...
                    	<div class="mb-3">
                            ...
                            name="PiexelAddToCart"
                             rows="5">{{$ads->PiexelAddToCart}}</textarea>
                    		<div id="emailHelp" class="form-text"><i>Basta copiar e colar seus códigos acima.</i></b></div>
                    	</div>
                    	...
                    	<div class="mb-3">
                            ...
                            id="PiexelPurchase"
                            name="PiexelPurchase"
                             rows="5">{{$ads->PiexelPurchase}}</textarea>
                    		<div id="emailHelp" class="form-text"><i>Basta copiar e colar seus códigos acima.</i></b></div>
                    	</div>
                    ...
                    {{ csrf_field() }}
                    	...
                    	<div class="mb-3">
                            ...
                            name="cod_header_google"
                             rows="5">{{$ads->cod_header_google}}</textarea>
                    		<div id="emailHelp" class="form-text"><i>Copie e cole seu codigo acima.</i></div>
                    	</div>
                    	<div class="mb-3">
                            ...
                            name="cod_body_google"
                             rows="5">{{$ads->cod_body_google}}</textarea>
                    		<div id="emailHelp" class="form-text"><i>Basta copiar e colar seus códigos acima.</i></b></div>
                    	</div>
                    	<button type="submit" class="btn btn-sm btn-primary"><b><i class="far fa-save"></i> SALVAR ALTERAÇÕES</b></button>
                    </form>
