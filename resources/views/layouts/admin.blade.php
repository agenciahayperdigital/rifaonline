                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('tutoriais') }}"
                                class="nav-link {{ request()->is('tutoriais*') ? 'active' : '' }}" id="wpp-msgs">
                        ...
                        {{-- <li class="nav-item">
                            <a href="{{route('caixaDeMenssagens')}}" class="nav-link" id="perfil" >
                                <i class="fas fa-envelope-open-text"></i>
                                <p>Caixa de Menssagens</p>
                            </a>
                        </li> --}}

                        <li class="nav-item">
                            <a href="{{ route('gateway_pagamento') }}"
                                class="nav-link {{ request()->is('gateway_pagamento*') ? 'active' : '' }}"
                                id="perfil">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('pixel_google_ads') }}"
                                class="nav-link {{ request()->is('pixel_google_ads*') ? 'active' : '' }}"
                                id="perfil">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('addNovaFazendinha') }}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('cadNovoAfililiado') }}"
                                class="nav-link" >
                                <i class="fas fa-user-edit"></i>
